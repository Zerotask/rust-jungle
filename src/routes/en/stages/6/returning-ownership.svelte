...
<Lesson
	...
	summary="Ownership can also be returned from a function"
	tags="ownership"
	previous="moving-ownership"
	next="borrowing-ownership-with-references"
...
>
	<p>Ownership can also be returned from a function.</p>
</Lesson>
