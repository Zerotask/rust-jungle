...
>
	...
	<p>
		Visual Studio Code is a modular editor which can be extended with with useful tools (called <i
			>extensions</i
		>) to improve your developing experience for Rust programming.
	</p>
