...
<Lesson
	title="Stage 4.6: Tuple-like Structs"
...
>
	<p>For conciseness, you can create structs that are used like a tuple.</p>

	<p>This is a good practice to improve the readability of your code by giving the tuple a name.</p>
</Lesson>
