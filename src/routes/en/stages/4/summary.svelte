...
<Lesson index={10} previous="enums-with-data">
	<p>
		...
		conciseness with its types. Next up we will talk about a concept that gives our data types even
		more flexibility of representation: <i>generics</i>.
	</p>
</Lesson>
