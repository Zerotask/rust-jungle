...
<Lesson index={10} previous="vectors">
	<p>
		...
		see again and again in code. Our functions are getting quite lengthy! In our next chapter we
		will spend talk about an important concept in Rust: data ownership.
	</p>
</Lesson>
